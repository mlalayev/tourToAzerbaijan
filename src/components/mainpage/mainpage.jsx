...
function mainpage() {
  ...
  const [isRotatedDownFifthSection, setIsRotatedDownFifthSection] =
    useState(false);

  useEffect(() => {
    const handleOutsideClickUp = handleClickOutside(
      dropdownRefUp,
      setIsRotatedUp
    );
    const handleOutsideClickDown = handleClickOutside(
      dropdownRefDown,
      setIsRotatedDown
    );
    const handleOutsideClickDownFifth = handleClickOutside(
      dropdownRefDownFifthSection,
      setIsRotatedDownFifthSection
    );
          ...
          <div className="city-choose">
            <div className="left-button">
              <div
                ...
                className={`lftlftbtndrpdwnn  ${
                  isRotatedUp ? "lftlftbtndrpdwnactive" : ""
                }`}
              >
                {t(`cities.${cityLi}`)}{" "}
                <RiArrowDownSLine
                  strokeWidth={2}
                  style={{ transform: isRotatedUp ? "rotate(180deg)" : "none" }}
                />
                <ul
                  className={`lftlftbtndrpdwnul ${
                    isRotatedUp ? "lftlftbtndrpdwnulactive" : ""
                  }`}
                >
                  {cityData.cities.map((city, index) => (
                    <li
                      key={index}
                      onClick={() => handleCityChangeLi(city.cityLi)}
                    >
            ...
            <div className="checkoutpart">
              <span>
                {t("sectionfirst.findTours")}! <FaArrowRightLong />
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="containerscndsc">
          <div className="scndsctnup">
            ...
            <div className="sctnscndbtnhldr">
              <button className="btntoleft" onClick={handleScrollLeftScnd}>
                <FaAnglesLeft size={16} color={"white"} />
              </button>
              <button className="btntoright" onClick={handleScrollRightScnd}>
                <FaAnglesRight size={16} color={"white"} />
              </button>
            </div>
          </div>
          ...
          <div className="sliderholder" id="sectionsecond">
            ...
            <SLIDER
              imgg={sliderdos}
              huno={t("sectionsecond.sliderProps.sliderdos.huno")}
              p={t("sectionsecond.sliderProps.sliderdos.p")}
              btn={t("sectionsecond.sliderProps.sliderdos.btn")}
            />
            <SLIDER
              imgg={slidercuatro}
              huno={t("sectionsecond.sliderProps.slidercuatro.huno")}
              p={t("sectionsecond.sliderProps.slidercuatro.p")}
              btn={t("sectionsecond.sliderProps.slidercuatro.btn")}
            />
            <SLIDER
              imgg={slidertres}
              huno={t("sectionsecond.sliderProps.slidertres.huno")}
              p={t("sectionsecond.sliderProps.slidertres.p")}
              btn={t("sectionsecond.sliderProps.slidertres.btn")}
            />
            <SLIDER
              imgg={sliderpierci}
              huno={t("sectionsecond.sliderProps.sliderpierci.huno")}
              p={t("sectionsecond.sliderProps.sliderpierci.p")}
              btn={t("sectionsecond.sliderProps.sliderpierci.btn")}
            />
            <SLIDER
              imgg={slidersessi}
              huno={t("sectionsecond.sliderProps.slidersessi.huno")}
              p={t("sectionsecond.sliderProps.slidersessi.p")}
              btn={t("sectionsecond.sliderProps.slidersessi.btn")}
            />
            <SLIDER
              imgg={sliderseptini}
              huno={t("sectionsecond.sliderProps.sliderseptini.huno")}
              p={t("sectionsecond.sliderProps.sliderseptini.p")}
              btn={t("sectionsecond.sliderProps.sliderseptini.btn")}
            />
          </div>
        </div>
      </section>
        ...
        <div className="containerthrdsc">
          <div className="thrdsctnup">
            ...
            <div className="sctnthrdbtnhldr">
              <button onClick={handleScrollLeft} className="btntoleft">
                <FaAnglesLeft size={16} color={"white"} />
              </button>
              <button onClick={handleScrollRight} className="btntoright">
                <FaAnglesRight size={16} color={"white"} />
              </button>
            </div>
          </div>
          ...
          <div className="sliderholderthrd" id="sectionthird">
            ...
            <SLIDER
              imgg={slidershahdag}
              huno={t("sectionthird.sliderProps.slidershahdag.huno")}
              p={t("sectionthird.sliderProps.slidershahdag.p")}
              btn={t("sectionthird.sliderProps.slidershahdag.btn")}
            />
            <SLIDER
              imgg={khizidag}
              huno={t("sectionthird.sliderProps.khizidag.huno")}
              p={t("sectionthird.sliderProps.khizidag.p")}
              btn={t("sectionthird.sliderProps.khizidag.btn")}
            />
            <SLIDER
              imgg={ganimetpark}
              huno={t("sectionthird.sliderProps.ganimetpark.huno")}
              p={t("sectionthird.sliderProps.ganimetpark.p")}
              btn={t("sectionthird.sliderProps.ganimetpark.btn")}
            />
            <SLIDER
              imgg={mudvolcano}
              huno={t("sectionthird.sliderProps.mudvolcano.huno")}
              p={t("sectionthird.sliderProps.mudvolcano.p")}
              btn={t("sectionthird.sliderProps.mudvolcano.btn")}
            />
            <SLIDER
              imgg={hdlymosque}
              huno={t("sectionthird.sliderProps.hdlymosque.huno")}
              p={t("sectionthird.sliderProps.hdlymosque.p")}
              btn={t("sectionthird.sliderProps.hdlymosque.btn")}
            />
            <SLIDER
              imgg={yanardag}
              huno={t("sectionthird.sliderProps.yanardag.huno")}
              p={t("sectionthird.sliderProps.yanardag.p")}
              btn={t("sectionthird.sliderProps.yanardag.btn")}
            />
          </div>
        </div>
      </section>
      ...
      <section className="sectionfourth">
        <div className="containerfrthsc">
          <div className="frthlft">
            <h1 className="txtprtfrsth frthhuno">
              {t("sectionfourth.welcomeTo")}
            </h1>
            <div className="div">
              <h1 className="txtprtfrsth">
                {t("sectionfourth.azerbaijan")}{" "}
          ...
          <div className="frthrght">
            <p>
              {t("sectionfourth.planningTrip")}{" "}
              <a
                className="travelazer"
                target="_blank"
                href="https://azerbaijan.travel/"
              >
                {" "}
                Azerbaijan.travel
              </a>{" "}
              {t("sectionfourth.assistance")}
            </p>
            <div className="frthrghttxtprt">
              <div className="pprtuno">
                <div className="icons">
                  <GrUserManager size={32} color="black" />
                </div>{" "}
                <p className="frthrghtp">{t("sectionfourth.reasons.first")}</p>
              </div>

              <div className="pprtdos">
                <div className="icons">
                  <GrCertificate className="iconuno" size={32} color="black" />
                </div>{" "}
                <p className="frthrghtp">{t("sectionfourth.reasons.second")}</p>
              </div>

              <div className="pprttres">
                <div className="icons">
                  <LiaHandHoldingHeartSolid size={32} color="black" />
                </div>{" "}
                <p className="frthrghtp">{t("sectionfourth.reasons.third")}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="containerffthsc">
          <div className="ffthscup">
            ...
            <ul className="destinations">
              {citiesData.map((city) => (
                <li
                  className={`ulli ${
                    selectedCity === city.cityName ? "nulliactive" : ""
                  }`}
                  key={city.cityName}
                  onClick={() => {
                    handleCityChangem(city.cityName);
                    handleClickList();
                  }}
                >
            ...
            <div
              ref={dropdownRefDownFifthSection}
              onClick={handleClickDownFifthSection}
              className={`fifthsctndv ${
                isRotatedDownFifthSection ? "fifthsctndvactive" : ""
              }`}
            >
              {t("sectionfifth.chooseCity")}{" "}
              <RiArrowDownSLine
                strokeWidth={2}
                style={{
                  transform: isRotatedDownFifthSection
                    ? "rotate(180deg)"
                    : "none",
                }}
              />
              <ul
                className={`ffthsctnul ${
                  isRotatedDownFifthSection ? "ffthsctnulactive" : ""
                }`}
              >
                {citiesData.map((city) => (
                  <li
                    key={city.cityName}
                    onClick={() => handleCityChangem(city.cityName)}
                  >
          ...
          <div className="sldrhldrtwo">
            <div className="ffthscdwnlft">
              {selectedCity && (
                <div>
                  <h1 id="destinatonhuno">
                    {t(`citiesSlider.${selectedCity}.name`)}
                  </h1>
        ...
        <div className="containersxth">
          <div className="trstssy">
            ...
            <div className="rcmndtrst">
              {t("sectionsixth.testimonials", { returnObjects: true }).map(
                (testimonial, index) => (
